...
function switchLanguage(lang) {
    if (lang == "en") {
        ...
        document.getElementById("littledb_intro").innerHTML = "A simple C++ library provides an embedded K-V database and some encrypt/decrypt concerned functions.";
        ...
        document.getElementById("littledb_intro").innerHTML = "简单的 C++ 库，提供了一人嵌入式K-V数据库与一些加/解密相关的函数。";
        ...
        document.getElementById("littledb_intro").innerHTML = "単純なC++ライブラリは、組み込みのK-Vデータベースといくつかの暗号化/復号化に関連する機能を提供します。";
